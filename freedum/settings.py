...
SECRET_KEY = 'django-insecure-&xz6@s9pc%v*c1lj*affy0lci(hn87ni3kb9xs^&o429(+m+9r'
...
WSGI_APPLICATION = 'freedum.wsgi.application'
...
STATICFILES_DIRS = [
    BASE_DIR / 'static',  # This should already work, make sure `static` exists in your base directory
]
